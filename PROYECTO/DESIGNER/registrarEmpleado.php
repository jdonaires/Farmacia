...
if (isset($_POST['guardar'])) {
  ...
  $per->__SET('apellidos',$_POST['apellido']);
...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
  		...
  		<form class="form__reg" action="registrarpersona.php" method="post" >
              ...
              <input class="input-50" type="Direccion" placeholder="Correo"  name="direccion"  required autofocus><br>
              ...
              <div class="btn__form">
              	<input class="btn__submit" type="submit" value="REGISTRAR" name=guardar""><br>
