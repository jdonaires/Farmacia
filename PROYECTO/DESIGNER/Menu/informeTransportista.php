...
<head>
  ...
  <title>Informe Transportista</title>
</head>
...
<div class="container">
  <h2><span class="glyphicon glyphicon-fire"> </span > Informe  Transportista</h2>
</div>
    </nav>
  </header>
 <section class="main">
  ...
  <div class="row  container">
    ...
    <div class="col-md-12">
                <div class="col-md-2">
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="exampleCheck1">
                    <label class="form-check-label" for="exampleCheck1">NroLicencia:</label>
                  </div>
                </div>
                <div class="col-md-10">
                  <div class="form-group ">
                   ...
                   <div class="col-md-5 has-success">
<input type="text" name="NroLicencia" class="form-control" placeholder="NroLicencia" >
                   </div>
                   <div  class="col-md-2 ">
                     <button class="btn btn-primary btn-block" name="buscar">Buscar</button>
                   </div>
