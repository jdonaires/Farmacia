...
<div class="container">
  <h2><span class="glyphicon glyphicon-fire"> </span > Informe Laboratorio</h2>
...
<div class="col-md-6">
  ...
  <div class="panel-heading"><h3>Nombre</h3></div>
  ...
  <div class="form-group ">
   <label class="control-label col-md-3" >Laboratorio:</label>
   <div class="col-md-5 has-success">
